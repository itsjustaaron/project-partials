...
async function getAudio() {
  ...
  source.connect(analyzer); // set how much data is analyzed

  analyzer.fftSize = 2 ** 10; // get the data from the audio
...
function drawTime(timeData) {
  ...
  context.stroke(); // call itself on repaint
...
getAudio();
},{"./utils":"utils.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
