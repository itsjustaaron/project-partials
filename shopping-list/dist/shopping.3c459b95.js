...
function handleSubmit(e) {
  ...
  items.push(item);
  console.log("There are ".concat(items.length, " item(s) in your state."));
  e.target.reset();
...
function retrieveFile() {
  ...
  var filedItems = JSON.parse(localStorage.getItem('items'));

  if (filedItems.length) {
    var _items;

    (_items = items).push.apply(_items, _toConsumableArray(filedItems));
...
list.addEventListener('itemsUpdated', fileIntoStorage); // listen for click on list, delegate to button if it was clicked
